...
model = GIN_PYG(num_features, 80, n_classes).to(device)
...
for epoch in range(1, 201):
    t1 = time.time()
    train_loss, train_acc, optimizer= train_pyg('gin', model, train_loader, device, optimizer)
